...
const u8 gText_AttackUp[] = _("{UP_ARROW_2}ATTACK");
const u8 gText_DefenseUp[] = _("{UP_ARROW_2}DEFENSE");
const u8 gText_SpAtkUp[] = _("{UP_ARROW_2}SP. ATK");
const u8 gText_SpDefUp[] = _("{UP_ARROW_2}SP. DEF");
const u8 gText_SpeedUP[] = _("{UP_ARROW_2}SPEED");
const u8 gText_AttackDown[] = _("{DOWN_ARROW_2}ATTACK");
const u8 gText_DefenseDown[] = _("{DOWN_ARROW_2}DEFENSE");
const u8 gText_SpAtkDown[] = _("{DOWN_ARROW_2}SP. ATK");
const u8 gText_SpDefDown[] = _("{DOWN_ARROW_2}SP. DEF");
const u8 gText_SpeedDown[] = _("{DOWN_ARROW_2}SPEED");
const u8 gText_UpArrow[] = _("{UP_ARROW_2}");
const u8 gText_DownArrow[] = _("{DOWN_ARROW_2}");
const u8 gText_HP4[] = _("HP");
const u8 gText_Nature[] = _("NATURE");
const u8 gText_EmptyString8[] = _("");
const u8 gText_OT[] = _C("OT");
const u8 gText_OTSlash[] = _C("OT/");
const u8 gText_Species[] = _("SPECIES");
...
const u8 gText_Category[] = _("CATEGORY");
...
const u8 gText_Controls_PageCancel[] = _("{DPAD_LEFTRIGHT}PAGE {A_BUTTON}CANCEL");
const u8 gText_Controls_PageIVsEVs[] = _("{DPAD_LEFTRIGHT}PAGE {A_BUTTON}IVS/EVS");
const u8 gText_Controls_PageBase[] = _("{DPAD_LEFTRIGHT}PAGE {A_BUTTON}BASE");
const u8 gText_Controls_PageStats[] = _("{DPAD_LEFTRIGHT}PAGE {A_BUTTON}STATS");
const u8 gText_Controls_PageDetail[] = _("{DPAD_LEFTRIGHT}PAGE {A_BUTTON}DETAIL");
const u8 gText_Controls_PickForget[] = _("{DPAD_UPDOWN}PICK {A_BUTTON}FORGET");
const u8 gText_Controls_PickSwitch[] = _("{DPAD_UPDOWN}PICK {A_BUTTON}SWITCH");
