...
extern const u8 gText_Controls_PageCancel[];
extern const u8 gText_Controls_PageIVsEVs[];
extern const u8 gText_Controls_PageBase[];
extern const u8 gText_Controls_PageStats[];
extern const u8 gText_Controls_PageDetail[];
extern const u8 gText_Controls_PickForget[];
extern const u8 gText_Controls_PickSwitch[];
...
extern const u8 gText_AttackUp[];
extern const u8 gText_DefenseUp[];
extern const u8 gText_SpAtkUp[];
extern const u8 gText_SpDefUp[];
extern const u8 gText_SpeedUP[];
extern const u8 gText_AttackDown[];
extern const u8 gText_DefenseDown[];
extern const u8 gText_SpAtkDown[];
extern const u8 gText_SpDefDown[];
extern const u8 gText_SpeedDown[];
extern const u8 gText_UpArrow[];
extern const u8 gText_DownArrow[];
extern const u8 gText_Nature[];
